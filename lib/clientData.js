    ...
    if (clientItem) {
        if (typeof clientItem === 'string') {
            if (type === 'foundations') {
                ...
                console.log(`bundle lookup ${lookup}`)
            } else {
...
const ClientData = {
    ...
    clientItemsForType(type, component) {
        ...
        } else if ((lookupType === "wires") && (component.clientItem.messenger !== undefined)) {
                let clientItem = component.clientItem;
                clientItems["bundles"] = [clientItem];
                clientItems["wires"] = [clientItem];
                // mergeClientItems(clientItems, item.bundleComponents);
                // clientItems["bundleComponents"] = item.bundleComponents;
