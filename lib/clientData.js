...
const ClientData = {
    ...
    clientItemsForType(type, component) {
        ...
        } else if ((lookupType === "bundles")){
            console.log("lookuptype bundles")
                ...
                mergeClientItems(clientItems, this.find('bundles', { size: clientItem.size }));
                //TODO need to extract and merge bundle components with bundles.
                //TODO bundles should also be wires?
                mergeClientItems(clientItems, this.find('bundleComponents', { size: clientItem.bundleComponents.size }))
