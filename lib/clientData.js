...
function createClientItems(clientData) {
    ...
    return {
        ...
        clientItemVersions: clientItemVersions,
        ...
        clientItemsForType(type, component) {
            ...
            if (lookupType === 'assemblies') {
                ...
                if (component.support) {
                    ...
                    mergeClientItems(clientItems, this.findOneOf(['assemblies','anchors','wires'], {
                        alias: clientItem,
                        size: clientItem,
                        code: clientItem
                    }));
                    ...
                    for (let attachment of support.attachments) {
                        ...
                        mergeClientItems(clientItems, this.findOneOf(['assemblies','wires'], {
